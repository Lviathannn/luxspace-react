      ...
      <section className="container mx-auto">
         <div className="flex flex-wrap my-4 md:my-12">
            ...
            <div className="flex-1 px-4 md:p-6">
               ...
               <a
                  href="cart.html"
                  className="transition-all duration-200 bg-blue-400 text-black focus:bg-black focus:text-blue-400 rounded-full px-8 py-3 mt-4 inline-flex"
               >
                  <svg
               ...
               <p className="text-xl leading-7">
                  ...
                  perfect solution for the way we work today. A comprehensive
                  product family, Jetty features a variety of elegant chairs and
                  sofas.
               </p>
            </div>
         </div>
